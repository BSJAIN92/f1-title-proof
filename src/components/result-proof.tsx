...
export function ResultProof({result}:{result:HeadToHeadResult}){
 ...
 if(!example)return <section className="result-block result-impossible" role="status"><span aria-hidden="true">NO PATH</span><h4>No valid head-to-head scenario exists</h4><p>Based on the current standings and remaining points, {result.targetId} cannot finish ahead of {result.rivalId}.</p></section>;
